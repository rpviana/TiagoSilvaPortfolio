export default {
  ...
  about: {
    ...
    shortBio: {
      ...
      paragraph1: 'Violinist Tiago Soares Silva is a versatile performer dedicated to presenting both traditional repertoire and contemporary music to audiences worldwide. His artistic vision combines technical excellence with profound musical expression.',
      paragraph2: 'Tiago is a founding member of several innovative ensembles including the 97 Ensemble and Constelação 15, where he explores new creative possibilities and collaborative musical expressions.'
    },
    fullBio: {
      title: 'Full Biography',
      paragraph1: 'Tiago Soares Silva is a Portuguese violinist whose performances are characterized by their emotional depth, technical precision, and thoughtful interpretations. His artistic journey began in his homeland of Portugal before taking him to prestigious institutions across Europe, where he refined his craft under the guidance of renowned teachers and mentors.',
      paragraph2: 'As a soloist, Tiago has appeared with orchestras across Europe, presenting a diverse repertoire spanning from baroque masterpieces to contemporary works. His interpretations of Bach\'s Solo Sonatas and Partitas have garnered particular critical acclaim for their clarity, expressiveness, and historical awareness.',
      paragraph3: 'A passionate advocate for new music, Tiago regularly collaborates with composers to premiere and record new works for violin. He has commissioned several pieces that expand the technical and expressive capabilities of the instrument while engaging with contemporary musical languages and concerns.',
      paragraph4: 'In addition to his performance career, Tiago is committed to music education and outreach, giving masterclasses and workshops that seek to inspire the next generation of musicians and build new audiences for classical and contemporary music.'
    },
    education: {
      title: 'Education',
      item1: 'Royal Academy of Music, London - Master of Music (Distinction)',
      item2: 'Escola Superior de Música de Lisboa - Bachelor of Music (First Class Honours)',
      item3: 'Masterclasses with Maxim Vengerov, Leonidas Kavakos, and Midori'
    },
    awards: {
      title: 'Awards & Recognition',
      item1: 'First Prize, International Violin Competition of Portugal (2019)',
      item2: 'Young Artist Award, Classical Music Foundation (2021)',
      item3: 'Artist in Residence, Gulbenkian Foundation (2022-2023)'
    }
  },
