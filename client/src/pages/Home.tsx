        ...
        <div className="container mx-auto px-4 h-full flex items-end pb-28 md:pb-40 relative z-10">
          <div className="max-w-3xl text-white">
            ...
            >
              <Link
                href="/contact"
                className="inline-block bg-primary hover:bg-primary-dark text-white px-8 py-3 rounded tracking-wide transition-colors"
              >
                {t("home.cta")}
              </Link>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-playfair font-bold mb-3 text-primary">
                    97 Ensemble
                  </h3>
              ...
              <div className="md:col-span-2 bg-white rounded-lg shadow-md p-8">
                ...
                <div className="space-y-4 mb-6">
                  <div className="border-l-2 border-primary/50 pl-4">
                    <div className="text-sm text-gray-500 mb-1">
                      15 {t("events.months.october")} 2023
                    </div>
                    <div className="font-medium">
                      {t("events.event1.title")}
                    </div>
                    <div className="text-sm text-gray-600">
                      {t("events.event1.venue")}
                    </div>
                  </div>

                  <div className="border-l-2 border-primary/50 pl-4">
                    <div className="text-sm text-gray-500 mb-1">
                      03 {t("events.months.november")} 2023
                    </div>
                    <div className="font-medium">
                      {t("events.event2.title")}
                    </div>
                    <div className="text-sm text-gray-600">
                      {t("events.event2.venue")}
                    </div>
                  </div>
                </div>
                ...
                <Link
                  href="/events"
                  className="inline-block text-primary hover:text-primary-dark flex items-center"
                >
