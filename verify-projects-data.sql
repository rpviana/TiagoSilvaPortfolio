-- Query para verificar se os dados estão na base de dados
SELECT key, 
       LEFT(value_pt, 50) as value_pt_preview,
       LEFT(value_en, 50) as value_en_preview,
       type
FROM site_content 
WHERE key LIKE 'projects_%'
ORDER BY key;

-- Se não houver resultados, executar este INSERT:
/*
